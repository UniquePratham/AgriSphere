      ...
      <div className="container px-4 py-12 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <h3 className="text-lg font-semibold">AgriSphere</h3>
            <p className="text-sm text-muted-foreground">
              A unified innovation ecosystem where multiple domains converge to
              create the future.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>
                <Link href="/agriculture" className="hover:text-foreground">
                  Agricultural AI
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 pt-8 border-t text-center text-sm text-muted-foreground">
          <p>
            &copy; 2024 AgriSphere. All rights reserved. Built for innovation
            across domains.
          </p>
        </div>
      </div>
