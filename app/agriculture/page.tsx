...
const weatherData = [
  { metric: 'Temperature', value: '24°C', status: 'Optimal', icon: Thermometer },
    ...
    <div className="container px-4 py-8 space-y-8">
      ...
      >
        ...
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          AI-powered agriculture solutions for sustainable farming and yield optimization
        </p>
      </motion.div>
          ...
          >
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">{weather.metric}</CardTitle>
                <weather.icon className="w-4 h-4 text-muted-foreground" />
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold mb-1">{weather.value}</div>
                <div className={`text-xs font-medium ${
                  weather.status === 'Optimal' ? 'text-green-600' :
                  weather.status === 'Good' ? 'text-blue-600' :
                  weather.status === 'Moderate' ? 'text-yellow-600' :
                  'text-red-600'
                }`}>
                  {weather.status}
                </div>
                  ...
                  >
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <div className="text-right">
                        ...
                        <div className="text-lg font-bold text-emerald-600">{crop.health}%</div>
                      </div>
                    </div>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-medium text-emerald-600">+18.7%</span>
                    </div>
                    <div className="flex justify-between items-center">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-medium text-yellow-600">2 identified</span>
                    </div>
                  </CardContent>
                </Card>
            ...
            <TabsContent value="soil" className="space-y-4">
              <div className="text-center space-y-4">
                ...
                <p className="text-muted-foreground max-w-md mx-auto">
                  AI-powered soil analysis using satellite imagery and IoT sensor data.
                </p>
            ...
            <TabsContent value="supply" className="space-y-4">
              <div className="space-y-6">
                <div className="text-center">
                  ...
                  <h3 className="text-lg font-medium">Supply Chain Optimization</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <Card>
                    ...
                    <CardContent className="text-center">
                      ...
                      <div className="text-sm text-muted-foreground">Transport Costs</div>
                    </CardContent>
                  </Card>
                  ...
                  <Card>
                    ...
                    <CardContent className="text-center">
                      <div className="text-2xl font-bold text-emerald-600 mb-1">+31%</div>
                      <div className="text-sm text-muted-foreground">Carbon Efficiency</div>
                    </CardContent>
                  </Card>
                </div>
              </div>
